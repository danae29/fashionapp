...
class Date extends React.Component {
  state = {
    ...
    imageFeed: [
      {
        image:
          'https://codehs.com/uploads/7afab87210d99267c7b6c4f6e83ada39',
          
      },

      {
        image: 'https://codehs.com/uploads/9f4cab59e62d976ca675e8e1608cc317',
    ...
    return (
      ...
      <View style={{ display: this.state.loginDisplay }}>
       <View style={styles.contentContainer}>
        <Text style={styles.logoText}> Date Attire</Text>
